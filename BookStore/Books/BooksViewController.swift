...
//        topImageView?.layer.borderWidth = 1
        ...
        booksCarruselView.backgroundColor = .clear
        ...
        booksCollectionView.addAnchors(left: 10, top: 250, right: 10, bottom: 20, withAnchor: .top, relativeToView: topImageView)
...
//        booksCollectionView.topAnchor.constraint(equalTo: topImageView.topAnchor, constant: 50) .isActive = true
    ...
    func getData() {
        // MARK: - LIBROS
        let elSeñorDeLosAnillos = Libro(bookTitle: "El señor de los anillos", bookPrice: 400, bookPages: 423, bookFormat: "ebook", bookDescription: "La novela narra el viaje del protagonista principal, Frodo Bolsón, hobbit de la Comarca, para destruir el Anillo Único y la consiguiente guerra que provocará el enemigo para recuperarlo, ya que es la principal fuente de poder de su creador, el Señor oscuro, Sauron.", bookLanguage: "español", bookImage: "el señor de los anillos", author: "Tolkien")
        let historiasMexicas = Libro(bookTitle: "Historias Mexicas", bookPrice: 450, bookPages: 271, bookFormat: "pasta blanda", bookDescription: "Historias mexicas nos lleva a pensar las crónicas indígenas como el producto de un diálogo complejo entre lo indígena y lo europeo, y, en este caso, no sólo serían obra de invención, sino también de reinvención. Aquí el indígena es un ser activo y no aquello que la cotidianidad se ha acostumbrado a hacer de menos.", bookLanguage: "español", bookImage: "historias mexicas", author: "Federico Navarrete")
        let elOrigenDeLasEspecies = Libro(bookTitle: "el origen de las especies", bookPrice: 300, bookPages: 451, bookFormat: "pasta blanda", bookDescription: "El libro de Darwin introdujo la teoría científica de que las poblaciones evolucionan durante el transcurso de las generaciones mediante un proceso conocido como selección natural. Presentó pruebas de que la diversidad de la vida surgió de la descendencia común a través de un patrón ramificado de evolución.", bookLanguage: "español", bookImage: "el origen de las especies", author: "Charles Darwin")
        let vidaEntreVidas = Libro(bookTitle: "vida entre vidas", bookPrice: 200, bookPages: 315, bookFormat: "pasta blanda", bookDescription: "Este libro es más que un manual técnico de metodología, ya que estimula la reflexión personal sobre las maravillas de una creación multidimensional y de nuestro papel en ella, ya sea como almas o como seres humanos encarnados.", bookLanguage: "español", bookImage: "vida entre vidas", author: "Michael  Newton")
        let elFiloDeLaNavaja = Libro(bookTitle: "El Filo De la Navaja", bookPrice: 300, bookPages: 286, bookFormat: "pasta blanda", bookDescription: "Una revolución de la conciencia que vaya de lo personal a lo global y de lo mundano a lo trascendente. Vivimos en un mundo en crisis cuya realidad, a menudo, no sabemos cómo abordar. Vivimos en un mundo en crisis cuya realidad, a menudo, no sabemos cómo abordar.", bookLanguage: "español", bookImage: "el filo de la navaja", author: "Osho")
        let elCastilloAmbulante = Libro(bookTitle: "El Castillo Ambulante", bookPrice: 400, bookPages: 347, bookFormat: "pasta dura", bookDescription: "Cuando la Bruja del Páramo convierte a Sophie Hatter en una anciana, la joven abandona la sombrerería familiar para pedir ayuda en el único lugar mágico que se le ocurre: el castillo ambulante que atemoriza a los habitantes de Market Chipping.", bookLanguage: "español", bookImage: "el castillo ambulante", author: "Diana Wynne Jones")
        let elOrigenDeLaTragedia = Libro(bookTitle: "El Origen de la Tragedia", bookPrice: 600, bookPages: 208, bookFormat: "pasta dura", bookDescription: "Opera prima de Friedrich Nietzsche, El origen de la tragedia es una obra intrépida y chispeante, llena de arrojo intelectual y entusiasmo juvenil, que desconcertó y fue malinterpretada por sus contemporáneos. El propio Nietzsche la calificó quince años después como un libro imposible por la ambigüedad de su estilo.", bookLanguage: "español", bookImage: "el origen de la trajedia", author: "Nietzsche")
        let viajeAlCentroDeLaTierra = Libro(bookTitle: "Viaje al Centro de la Tierra", bookPrice: 60, bookPages: 93, bookFormat: "pasta blanda", bookDescription: "Viaje al centro de la Tierra (Voyage au centre de la Terre) es una novela de Julio Verne, publicada el 25 de noviembre de 1864; la cual trata de la expedición de un profesor de mineralogía, Otto Lidenbrock, su sobrino Axel y un guía llamado Hans al interior de la Tierra.", bookLanguage: "español", bookImage: "viaje al centro de la tierra", author: "Julio Verne")
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let producto = dataSource?.authorName?[indexPath.section].authorBooks?[indexPath.row]
