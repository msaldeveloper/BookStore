...
class BooksViewController: UIViewController , BookManagerDelegate{
    ...
    func initUi() {
        ...
        booksCollectionView.addAnchors(left: 10, top: 100, right: 10, bottom: 20, withAnchor: .top, relativeToView: topImageView)
...
//        booksCollectionView.topAnchor.constraint(equalTo: topImageView.topAnchor, constant: 50) .isActive = true
    ...
    func didUpdateBook(_ bookManager: BookManager, bookid: BookModel) {
        DispatchQueue.main.async {
            ...
            self.present(RegisterViewController,animated: true,completion:{print("register button press")} )
        }
//        DispatchQueue.main.async {
